...
/*
 * @brief: this is the pointer to function that holds the address of the Timer Interrupt Handler 
 */
...
/*
 * @brief: This function is used to initialize the SYSTICK timer
 * @ret:   Nothing 
 * @param: No Parameters 
 */
...
/*
 * @brief: This function is used to Stop the SYSTICK timer
 * @ret:   Nothing 
 * @param: No Parameters 
 */
...
/*
 * @brief: This function is used to make delay and stop the system for specific period
 * @ret:   Nothing 
...
/*
 * @brief: This function is used to make delay but with event trigger only once 
 * @ret:   Nothing 
 * @param1: Copy_u32Ticks -> holds the desired value of time in ticks
...
/*
 * @brief: This function is used to make delay but with event trigger periodicly 
 * @ret:   Nothing 
 * @param1: Copy_u32Ticks -> holds the desired value of time in ticks
 * @param2: this is the address of the ISR function that you want to be executed in the Interrupt   
 */
...
/*
 * @brief: This function is used to get the finished time
...
/*
 * @brief: This function is used to get the remaining time
...
/*
 * @brief: this is function used for the calling the ISR 
 * @ret:   Nothing   
 * @param: No Parameters 
 */
