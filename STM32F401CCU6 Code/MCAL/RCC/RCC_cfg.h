 ...
 *    3-       RCC_PLL        //2
*/
#define RCC_SELECT_SYSTEM_CLOCK        RCC_HSI  // 25M
 ...
 *     2- DISABLE            //0
*/
#define   RCC_HSE_ENABLE    DISBLE
#define   RCC_HSI_ENABLE    ENABLE
#define   RCC_PLL_ENABLE    DISBLE
...
/** 
 * If you enable PLL, Determine your O/P Freq F
 * Methods:
 ...
 * 
 * The SDIO and the Random number generator need a frequency
